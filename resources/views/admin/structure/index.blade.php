...
@section('content')
    <main class="h-full overflow-y-auto">
        <button type="button"
            class="border border-green-700 bg-green-700 text-white rounded-md px-4 py-2 mb-4 transition duration-500 ease select-none hover:bg-green-600 focus:outline-none focus:shadow-outline">
            <a href="/admin/structures/create" class="">Tambah Data</a>
        </button>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        @foreach ($structures as $structure)
                            <tr
                                ...
                                <td class="px-4 py-3">{{ $structure->name }}</td>
                                <td class="px-4 py-3">{{ $structure->jabatan }}</td>
                                <td class="px-4 py-3">{{ $structure->bidang }}</td>
                                <td class="px-4 py-3">{{ $structure->angkatan }}</td>
                                <td class="px-4 py-3">{{ $structure->jurusan }}</td>
                                ...
                                <td class="px-4 py-3  flex justify-center ">
                                    <button type="button"
                                        ...
                                        <a href="{{ route('structures.edit', $structure->id) }}">Edit</a>
                                    </button>
