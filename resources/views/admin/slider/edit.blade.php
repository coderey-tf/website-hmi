            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="block text-lg form-group">
                    ...
                    <input
                        ...
                        placeholder="Judul" name="title" value="{{ $slider->title }}" />
                </div>
                @error('title')
                ...
                <div class="block mt-4 text-lg form-group">
                    ...
                    <textarea
                        ...
                        rows="3" placeholder="Deskripsi" name="description">{{ $slider->description }}</textarea>
                </div>
                @error('description')
                    <small style="color:red">{{ $message }}</small>
                @enderror

                <img src="{{ asset('image/' . $slider->image) }}" alt="" class="img-fluid mt-4" width="150">
