...
@section('content')
    <main class="h-full overflow-y-auto">
        <button type="button"
            ...
            <a href="/admin/contacts/create" class="">Tambah Data</a>
        </button>
                ...
                <table class="w-full border-separate ">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3 w-52">Maps Embed</th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        @foreach ($contacts as $contact)
                            <tr
                                ...
                                <td class="px-4 py-3">{{ $contact->alamat }}</td>
                                <td class="px-4 py-3">{{ $contact->email }}</td>
                                <td class="px-4 py-3">{{ $contact->phone }}</td>
                                <td class="px-4 py-3">{{ $contact->whatsapp }}</td>
                                <td class="px-4 py-3">{{ $contact->maps_embed }}</td>
