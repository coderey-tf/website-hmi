            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="block text-lg form-group">
                    ...
                    <input
                        ...
                        placeholder="Alamat" name="alamat" value="{{ $contact->alamat }}" />
                </div>
                @error('alamat')
                ...
                <div class="block text-lg form-group">
                    ...
                    <input
                        class="block w-full mt-1 text-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Email" name="email" value="{{ $contact->email }}" />
                </div>
                @error('email')
                    <small style="color:red">{{ $message }}</small>
                @enderror
                ...
                <div class="block text-lg form-group">
                    ...
                    <input
                        class="block w-full mt-1 text-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Phone" name="phone" value="{{ $contact->phone }}" />
                </div>
                @error('phone')
                    <small style="color:red">{{ $message }}</small>
                @enderror
                ...
                <div class="block text-lg form-group">
                    ...
                    <input
                        class="block w-full mt-1 text-lg dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Whatsapp" name="whatsapp" value="{{ $contact->whatsapp }}" />
                </div>
                @error('whatsapp')
                    <small style="color:red">{{ $message }}</small>
                @enderror
                ...
                <div class="block mt-4 text-lg form-group">
                    ...
                    <textarea
                        ...
                        rows="3" placeholder="Maps Embed" name="maps_embed">{{ $contact->maps_embed }}</textarea>
                </div>
                @error('maps_embed')
                    <small style="color:red">{{ $message }}</small>
                @enderror
