            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="block mt-4 text-lg form-group">
                    ...
                    <input
                        ...
                        name="judul" value="{{ $article->judul }}" />
                </div>
                @error('judul')
                ...
                <div class="block mt-4 text-lg form-group">
                    ...
                    <textarea
                        ...
                        rows="3" id="editor" name="body">{{ $article->body }}</textarea>
                </div>
                @error('body')
                    <small style="color:red">{{ $message }}</small>
                @enderror
                ...
                <div class="block mt-4 text-lg form-group">
                    ...
                    <select
                        ...
                        @foreach ($categories as $category)
                            @if ($category->id == $article->kategori_id)
                                <option class="p-1" value="{{ $category->id }}" selected="selected">
                ...
                <img src="{{ asset('image/' . $article->gambar_artikel) }}" alt="" class="img-fluid mt-4"
                    width="150">
