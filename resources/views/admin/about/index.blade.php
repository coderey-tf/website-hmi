...
@section('title', 'Data Sejarah Komisariat')
...
@section('content')
    <main class="h-full overflow-y-auto">
        <button type="button"
            ...
            <a href="/admin/abouts/create" class="">Tambah Data</a>
        </button>
                ...
                <table class="w-full table-auto border-separate whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3 w-20">Tanggal Edit</th>
                            <th class="px-4 py-3">Sejarah</th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        @foreach ($abouts as $about)
                            <tr
                                ...
                                <td class="px-4 py-3">{{ $about->date }}</td>
                                <td class="px-4 py-3">{{ $about->sejarah }}</td>
                                <td class="px-4 py-3  flex justify-center ">
                                    <button type="button"
                                        class="border border-yellow-500 bg-yellow-500 text-white rounded-md px-4 py-2 mb-4 transition duration-500 ease select-none hover:bg-yellow-600 focus:outline-none focus:shadow-outline content-center">
